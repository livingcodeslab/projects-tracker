...
These curves are very weird, and to verify whether the chip was still
functioning as expected, we attempted to get new characteristics curves for the
chip for both open-air and with distilled water. The results are as follows:

- [ ] Add verification curves for open-air
- [ ] Add verification curves for distilled water

The new curves indicate that the new chip, chip01, had its characteristics
changed completely by the high concentration of PBS (for reference, Graphenea
used 0.001X PBS https://cdn.shopify.com/s/files/1/0191/2296/files/2025_Measurement_Protocols_GFET-S2X_v5.pdf?v=1736951757)

This is, probably the reason why the chips broke.
