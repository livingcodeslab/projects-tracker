...
- [ ] Write and debug software for driving everything
- …
...
*** ORDERED 1/4 inch tygon tubing              :livingcodeslab:gfet:orders:
 :PROPERTIES:
 :Link: https://www.amazon.com/Tygon-F-4040-Lubricant-Tubing-Length/dp/B000PHDLBI
...
*** ORDER Allen Key Wrench Set                :livingcodeslab:orders:tools:
 :PROPERTIES:
